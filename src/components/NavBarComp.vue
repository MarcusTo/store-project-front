        ...
        <div class="sidebar-content">
          ...
          <div v-if="isProductsDropdownVisible" class="dropdown-content">
            ...
            <div class="button-card">
              ...
              <div
                v-if="isPrebuiltDropdownVisible"
                class="dropdown-content nested-dropdown-content"
              >
                <RouterLink
                  to="#"
          ...
          <div class="button-card1">
            <div class="product-database-link-container">
              <RouterLink
                to="/productsdatabase"
                class="sidebar-link"
                @click="() => closeMenu('/productsdatabase')"
                >Products Database</RouterLink
              >
            </div>
          </div>
        </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      isAppleDropdownVisible,
      toggleAppleDropdown,
      isAndroidDropdownVisible,
      toggleAndroidDropdown,
      isPrebuiltDropdownVisible,
      togglePrebuiltDropdown,
      isComponentsDropdownVisible,
      toggleComponentsDropdown,
      isGearDropdownVisible,
      toggleGearDropdown,
