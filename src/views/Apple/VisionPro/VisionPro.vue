<template>
    ...
    <div class="product-cards">
      <router-link v-for="product in filteredProducts" :key="product._id" :to="`/apple/visionpro/${product._id}`" class="product-card-link">
  ...
  onMounted(async () => {
    try {
      ...
      products.value = data.filter(product => product.category === 'visionpro');
    } catch (error) {
